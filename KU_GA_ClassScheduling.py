...
#edit this one and add real info!
class Data:
    ...
    def __init__(self):
        ...
        course1 = Course("C1", "", [self._instructors[0], self._instructors[1]], 25)
        course2 = Course("C2", "", [self._instructors[0], self._instructors[1]], 25)
        course3 = Course("C3", "", [self._instructors[0], self._instructors[1]], 25)
        course4 = Course("C4", "", [self._instructors[2], self._instructors[1]], 25)
        course5 = Course("C5", "", [self._instructors[3], self._instructors[1]], 25)
        course6 = Course("C6", "", [self._instructors[0], self._instructors[1]], 25)
        course7 = Course("C7", "", [self._instructors[1], self._instructors[1]], 25)
...
class DisplayMgr:
    ...
    def print_course(self):
        availableCoursesTable = prettytable.PrettyTable(['id', 'course #', 'max # of students', 'isntructors'])
    ...
    def print_generation(self, population):
        table1 = prettytable.PrettyTable(['schedule #', '_fitness', '# of conflicts', 'classes[dept,class,room,instructor]'])
    ...
    def print_schedule_as_table(self, schedule):
        ...
        for i in range(0,len(classes)):
            table.add_row((str(i), classes[i].get_dept().get_name(), classes[i].get_course().get_name() + " (" + classes[i].get_course().get_number() + ", " + str(classes[i].get_course().get_maxNumbOfStudents()) + ")", classes[i].get_instructor().get_name() + "(" + str(classes[i].get_instructor().get_id()) + ")", classes[i].get_meetingTime().get_time() + "(" + str(classes[i].get_meetingTime().get_id()) + ")" ))
        print(table)
